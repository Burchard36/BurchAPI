...
public class MojangToMapping {
    ...
    private static final Map<String, String> MC1_18R1 = new HashMap<>() {
    ...
    public static Map<String, String> getMapping(){
        return switch (MinecraftVersion.getVersion()) {
            case MC1_18_R2 -> MC1_18R2;
            case MC1_18_R1 -> MC1_18R1;
            default -> MC1_18R2;//throw new NbtApiException("This version of the NBTAPI is not compatible with this server version!");
        };
    }
