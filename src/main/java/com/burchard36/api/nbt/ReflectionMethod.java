package com.burchard36.api.nbt;

import com.burchard36.api.utils.Logger;
import com.burchard36.api.utils.MinecraftVersion;
    ...
    ReflectionMethod(ClassWrapper targetClass, Class<?>[] args, MinecraftVersion addedSince, MinecraftVersion removedAfter, Since... methodnames){
        ...
        try{
            ...
            try{
                ...
                Logger.warn("[NBTAPI] Unable to find the method '" + targetMethodName + "' in '" + (targetClass.getClazz() == null ? targetClass.getMojangName() : targetClass.getClazz().getSimpleName()) + "' Args: " + Arrays.toString(args) + " Enum: " + this); //NOSONAR This gets loaded before the logger is loaded
                ex2.printStackTrace();
            }
        }
    }
